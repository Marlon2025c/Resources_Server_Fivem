            ...
            if vehicle ~= 0 then
                ...
                if customtire[plate] and customtire ~= 'Default' then
                    ...
                    SetVehicleHandlingFloat(vehicle, "CHandlingData", "fLowSpeedTractionLossMult",
                        default.fLowSpeedTractionLossMult * tire.fLowSpeedTractionLossMult + 0.0) -- self.start burnout less = traction
                    SetVehicleHandlingFloat(vehicle, "CHandlingData", "fTractionLossMult",
                        default.fTractionLossMult * tire.fTractionLossMult + 0.0)                 -- asphalt mud less = traction
                    SetVehicleHandlingFloat(vehicle, "CHandlingData", "fTractionCurveMin",
                        default.fTractionCurveMin * tire.fTractionCurveMin + 0.0)                 -- accelaration grip
                    SetVehicleHandlingFloat(vehicle, "CHandlingData", "fTractionCurveMax",
                        default.fTractionCurveMax * tire.fTractionCurveMax + 0.0)                 -- cornering grip
                    SetVehicleHandlingFloat(vehicle, "CHandlingData", "fTractionCurveLateral",
                        default.fTractionCurveLateral * tire.fTractionCurveLateral + 0.0)         -- curve lateral grip
                end
            end
            Wait(1000)
        end
                ...
                if customturbo[plate] then
                    ...
                    while customturbo[plate] ~= nil and customturbo[plate] ~= 'Default' do
                        ...
                        if IsControlPressed(0, 32) then
                            ...
                            if not sound then
                                soundofnitro = PlaySoundFromEntity(GetSoundId(), "Flare", vehicle,
