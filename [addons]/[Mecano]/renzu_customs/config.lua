...
Config.VehicleMod = {
	...
	[45] = {
		...
		label = 'Refroidisseur intermédiaire',
		name = 'tank',
		index = 45,
		cost = 15000,
		percent_cost = 4,
	...
	[35] = {
		...
		cost = 15000,
		percent_cost = 3,
		camera = { val = 'back', x = 0.0, y = -1.0, z = 1.3 },
...
if GetGameBuildNumber() < 2372 then
	Config.VehicleMod[23]['list'] = {
		WheelType = { Sport = 0, Muscle = 1, Lowrider = 2, SUV = 3, Offroad = 4, Tuner = 5, BikeWheel = 6, HighEnd = 7 },
		WheelColor =
			allcolors,
		Accessories = { CustomTire = 1, BulletProof = 1, SmokeColor = 1, DriftTires = 1 }
	} -- BennysWheel = 8, BespokeWheel = 9
