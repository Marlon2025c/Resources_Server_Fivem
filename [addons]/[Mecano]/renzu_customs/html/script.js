            ...
            if (data[i] && data[i].label !== undefined) {
                if (i == 23) {
                    ...
                    for (const ind in data[index].list) {
                        if (ind == 'WheelType') {
                            $('#custom').append(`<button id="`+ind+`" class="modclass" onmouseover="menusound('menu')" onclick="menusound('click')"><img src="img/`+ind+`.svg"><div class="mod_title"><span>Jante type</span></div></button>`)
                            $("#"+ind+"").click(function(){
                                ShowWheelOption(data[i],data[i].max,data[index].list[ind])
                            });
                        } else if (ind == 'WheelColor') {
                            $('#custom').append(`<button id="`+ind+`" class="modclass" onmouseover="menusound('menu')" onclick="menusound('click')"><img src="img/`+ind+`.svg"><div class="mod_title"><span>Jante Couleur</span></div></button>`)
                            $("#"+ind+"").click(function(){
                                ShowWheelColorOption(data[i],data[i].max,data[index].list[ind])
                            });
                        } else if (ind == 'Accessories') {
                            $('#custom').append(`<button id="`+ind+`" class="modclass" onmouseover="menusound('menu')" onclick="menusound('click')"><img src="img/`+ind+`.svg"><div class="mod_title"><span>Accessoires</span></div></button>`)
                            $("#"+ind+"").click(function(){
...
function ShowWheelAcceOption(data,max,list) {
    ...
    setTimeout(function(){
        for (const i in list) {
            if (i == 'CustomTire') {
                $('#custom').append(`<button id="`+i+`" class="modclass" onmouseover="menusound('menu')" onclick="menusound('click')"><img src="img/28.svg"><div class="mod_title"><span>Pneu</span></div></button>`)
                $("#"+i+"").click(function() {
                ...
                $('#custom').prepend(`<button id="colordiv" class="modclass" onmouseover="menusound('menu')" onclick="menusound('click')"><input type="color" id="color" value="#ff0000"><div class="mod_title"><span>Fumée</span></div></button>`)
                colorPicker = document.querySelector("#color");
            ...
            /* } else if (i == 'BulletProof') {
                ...
                $('#custom').append(`<button id="`+i+`" class="modclass" onmouseover="menusound('menu')" onclick="menusound('click')"><img src="img/28.svg"><div class="mod_title"><span>Mode Drift</span></div></button>`)
                $("#"+i+"").click(function() {
